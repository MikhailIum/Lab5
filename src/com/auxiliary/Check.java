...
public class Check {
    ...
    public static boolean checkName(String name) {
        if (name == null || name.equals("")) {
            System.out.println(TextColor.ANSI_RED + "Field 'name' can't be an empty string" + TextColor.ANSI_RESET);
            return false;
        } else return true;
    }
    ...
    private static boolean checkCordArgs(String coords, String del) {
        if (coords == null || coords.equals("")) {
            System.out.println(TextColor.ANSI_RED + "Field 'coordinates' can't be an empty string" + TextColor.ANSI_RESET);
            return false;
        } else {
    ...
    /**
     * Checks if number of students/number of expelled students/number of students who should be expelled is in correct form
    ...
    public static boolean checkStudentsCount(String num, String field) {
        if (num == null || num.equals("")) {
            ...
            System.out.println(
                    TextColor.ANSI_RED + "'" + field + "' field should be a positive integer(<= " + Integer.MAX_VALUE + ")" + TextColor.ANSI_RESET);
            return false;
        }
    }
