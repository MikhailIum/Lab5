...
public class Person {
    ...
    public Person(String name, java.time.LocalDate birthday, Color hairColor, Country nationality, Location location){
        this.name = name;
    ...
    /**
     * Defines if tabs are necessary for printing info about admin
    ...
    public String toString(){
        ...
        String birthday_str = TextColor.ANSI_PURPLE + "\n" + tabs + "birthday" + TextColor.ANSI_WHITE + ": " + TextColor.ANSI_CYAN + birthday.format(DateTimeFormatter.ofPattern("dd.MM.yyyy")) + TextColor.ANSI_RESET;
        String hair_color_str = TextColor.ANSI_PURPLE + "\n" + tabs + "hair color" + TextColor.ANSI_WHITE + ": " + TextColor.ANSI_CYAN + hairColor + TextColor.ANSI_RESET;
        String nationality_str = TextColor.ANSI_PURPLE + "\n" + tabs + "nationality" + TextColor.ANSI_WHITE + ": " + TextColor.ANSI_CYAN + nationality + TextColor.ANSI_RESET;
        String location_str = TextColor.ANSI_PURPLE + "\n" + tabs + "location" + TextColor.ANSI_WHITE + ": " + TextColor.ANSI_RESET + "{" + location.toString() + "\n" + tabs + "}";
    ...
    public String getParams(){
        return name + "," + birthday.format(DateTimeFormatter.ofPattern("dd.MM.yyyy")) + "," + Color.find(hairColor) + "," +
                Country.find(nationality) + "," + location.getParams();
    }
